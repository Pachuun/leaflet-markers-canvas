(function (global, factory) {
  ...
  var copyToCanvas = function copyToCanvas(_ref) {
    ...
    var canvas = document.createElement('canvas'); //var svgSize = target.getBoundingClientRect();
    ...
    var buf = Buffer.from(unescape(encodeURIComponent(target)), "latin1");
    var buf64 = buf.toString('base64');
