(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('convert-svg-to-png'), require('leaflet'), require('rbush')) :
    typeof define === 'function' && define.amd ? define(['convert-svg-to-png', 'leaflet', 'rbush'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.require$$0, global.L, global.RBush));
})(this, (function (require$$0, L, RBush) { 'use strict';
    ...
    var test = require$$0__default["default"];
    ...
    var markersCanvas = {
        ...
        addMarkers: function addMarkers(markers) {
            ...
            markers.forEach(function (marker) {
                var ref = this$1$1._addMarker(marker);
                var markerBox = ref.markerBox;
                var positionBox = ref.positionBox;
                var isVisible = ref.isVisible;
        ...
        removeMarkers: function removeMarkers(markers) {
            ...
            markers.forEach(function (marker) {
                var latLng = marker.getLatLng();
                var isVisible = this$1$1._map.getBounds().contains(latLng);
                ...
                this$1$1._positionsTree.remove(positionBox, function (a, b) {
                    return a.marker._leaflet_id === b.marker._leaflet_id;
                });
        ...
        _initCanvas: function _initCanvas() {
            ...
            this._canvas = L__default["default"].DomUtil.create(
                "canvas",
            ...
            L__default["default"].DomUtil.addClass(
                this._canvas,
            ...
            if (marker.image) {
                ...
                if (this._icons[iconUrl]) {
                    ...
                    image.onload = function () {
                        this$1$1._icons[iconUrl].isLoaded = true;
                        this$1$1._icons[iconUrl].elements.forEach(function (ref) {
                            var marker = ref.marker;
                            var x = ref.x;
                            var y = ref.y;

                            this$1$1._drawImage(marker, { x: x, y: y });
                        });
                    };
                }
            } else if (hash) {
                if (this._icons[hash]) {
                    ...
                    if (this._icons[hash].isLoaded) {
                        ...
                        this._icons[hash].elements.push({ marker: marker, x: x, y: y });
                    }
                } else {
                    toImg(html);
                }
        ...
        _redraw: function _redraw(clear) {
            ...
            this._positionsTree.search(mapBoundsBox).forEach(function (ref) {
                ...
                var latLng = marker.getLatLng();
                var ref$1 = this$1$1._map.latLngToContainerPoint(latLng);
                var x = ref$1.x;
                var y = ref$1.y;
                ...
                this$1$1._drawMarker(marker, { x: x, y: y });
            });
